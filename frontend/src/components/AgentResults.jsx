  ...
  return (
    <div className="space-y-6">
      ...
      {(activeTab === 'all' || activeTab === 'agent6') && (
        <div className={`bg-white border rounded-2xl p-6 shadow-sm space-y-4 medtwin-hover-glow ${
      ...
      {(activeTab === 'all' || activeTab === 'agent1') && (
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-6 medtwin-hover-glow">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                {forecast.future_risks.map((fr, i) => (
                  <div key={i} className="bg-slate-50 border border-slate-200 rounded-xl p-4 text-xs space-y-1 medtwin-hover-glow">
                    <div className="flex items-center justify-between">
          ...
          {medication.safety_flags?.length > 0 && (
            <div className="bg-red-50 border border-red-200 rounded-xl p-4 space-y-2">
              ...
              {medication.safety_flags.map((flag, i) => (
                <div key={i} className="bg-white border border-red-200 rounded-lg p-3 text-xs space-y-1 medtwin-hover-glow">
