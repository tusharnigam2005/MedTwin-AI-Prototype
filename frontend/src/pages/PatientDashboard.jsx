...
export default function PatientDashboard() {
  ...
  if (currentPath === '/patient/reports') {
    ...
    pageTitle = 'Medical Reports & Lab Extraction (Agent 1)';
    pageSub = 'Extracted lab parameters, diagnostic findings, and raw medical document data.';
  } else if (currentPath === '/patient/health') {
    activeAgentTab = 'agent2';
    pageTitle = 'Health Risk & 7-Day Trajectory (Agents 2 & 3)';
    pageSub = 'Quantitative Health Score (0–100), risk factor assessments, and day-by-day forecast.';
  } else if (currentPath === '/patient/medications') {
    activeAgentTab = 'agent4';
    pageTitle = 'Medication Safety & Review (Agent 4)';
    pageSub = 'Dosage review, medication safety flags, and drug-drug interaction warnings.';
  } else if (currentPath === '/patient/recommendations') {
    activeAgentTab = 'agent5';
    pageTitle = 'Lifestyle & Diet Recommendations (Agent 5)';
    pageSub = 'Prioritized dietary modifications and exercise guidance generated by AI.';
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col font-sans">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        {/* Upload Medical Report & Agent Results View */}
        {loadingInitial ? (
        ...
        {/* Clean Blockchain Integration Placeholder */}
        <div className="bg-white border border-slate-200 rounded-2xl p-5 text-xs text-slate-500 flex items-center justify-between flex-wrap gap-3">
          <div className="flex items-center gap-2">
            ...
            <span><strong className="text-slate-700">Verification:</strong> Polygon SHA-256 Audit Log — Status: Verified / Active</span>
          </div>
